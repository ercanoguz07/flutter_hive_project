...
class DepositeMoneyPage extends StatefulWidget {
  const DepositeMoneyPage(
  ...
  @override
  _DepositeMoneyPageState createState() => _DepositeMoneyPageState();
}

class _DepositeMoneyPageState extends State<DepositeMoneyPage> {
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      if (double.parse(amountController.text.trim()) >
                          widget.totalAmount) {
                        EToast().showMessage(Toast.LENGTH_SHORT,
                            "Para miktarınızdan fazla para çekemezsiniz");
                        return;
                      }
                      ...
                      EToast().showMessage(
                          Toast.LENGTH_SHORT, "Para Çekme İşlemi Başarılı");
                      Navigator.pop(context);
                    },
                    child: Container(
                      height: 50,
